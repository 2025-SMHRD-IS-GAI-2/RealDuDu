      ...
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item selected">
          ...
          <ul aria-expanded="false" class="collapse first-level in">
            ...
            <li class="sidebar-item active"><a href="kickboard-register.jsp" class="sidebar-link"><i class="mdi mdi-plus-circle"></i><span class="hide-menu">킥보드 등록</span></a></li>
            ...
            <div class="d-flex align-items-center justify-content-end">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">킥보드 등록</li>
                </ol>
              </nav>
            </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="register-container">
          <div class="register-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title mb-4 text-center">새 킥보드 등록</h4>
                <form action="kickboardRegisterAction.jsp" method="post">
                  <div class="mb-3">
                    <label for="kickboardId" class="form-label">킥보드 ID</label>
                    <input type="text" class="form-control" id="kickboardId" name="kickboardId" placeholder="킥보드 ID를 입력하세요" required>
                  </div>
                  <div class="mb-3">
                    <label for="modelNm" class="form-label">모델명</label>
                    <input type="text" class="form-control" id="modelNm" name="modelNm" placeholder="모델명을 입력하세요" required>
                  </div>
                  <div class="mb-3">
                    <label for="kickboardSt" class="form-label">초기 상태</label>

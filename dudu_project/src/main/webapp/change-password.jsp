                ...
                <div class="card-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="currentPassword" type="password" placeholder="현재 비밀번호를 입력하세요">
                        </div>
                        
                        <hr> <div class="mb-3">
                            <label class="small mb-1" for="newPassword">새 비밀번호</label>
                            <input class="form-control" id="newPassword" type="password" placeholder="새 비밀번호">
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="confirmPassword">새 비밀번호 확인</label>
                            <input class="form-control" id="confirmPassword" type="password" placeholder="새 비밀번호를 다시 입력하세요">
                        </div>

                        <button class="btn btn-success btn-block" type="button">비밀번호 변경 완료</button>
                    </form>
                </div>
            </div>
        </div>
